...
/**
 * The <class>V19__configure_ui_defaults</class> is a migration
...
public class V19__configure_ui_defaults extends BaseDataMigration {
    ...
    protected void insertData() {
        ...
        updateEntityUi(Customer.class,
                ...
                update("salesRep", "Sales Representative"),
        ...
        updateEntityUi(Task.class,
                update("taskNumber", "Task Number", "{xtype: 'system-field-text', hidden:true}", "{hidden:true}"),
                update("folderLocation", "Folder Location", "{xtype: 'system-field-text',hideIfNull:true}", "{hidden:true}"),
                update("purchaseOrder", "PO #", "{maskIfInitialValueExists: true, allowBlank:false}"),
                update("job", "Job", "{maskIfInitialValueExists: true, hidden:true}", "{hidden:true}"),
