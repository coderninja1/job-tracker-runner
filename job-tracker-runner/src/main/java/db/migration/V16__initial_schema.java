        ...
        try {
            ...
            if (customerArray != null) {
                ...
                if (customerArray.length > 3)
                    customer.setSalesRep(getEntityPropertyValue(customerArray[3]));
                if (customerArray.length > 4)
                    customer.setAddressLine1(getEntityPropertyValue(customerArray[4]));
                if (customerArray.length > 5)
                    customer.setAddressLine2(getEntityPropertyValue(customerArray[5]));
                if (customerArray.length > 6)
                    customer.setAddressLine3(getEntityPropertyValue(customerArray[6]));
                if (customerArray.length > 7)
                    customer.setCity(getEntityPropertyValue(customerArray[7]));
                if (customerArray.length > 8)
                    customer.setState(getEntityPropertyValue(customerArray[8]));
                if (customerArray.length > 9)
                    customer.setZipCode(getEntityPropertyValue(customerArray[9]));
                if (customerArray.length > 10)
                    customer.setPhoneNumber(getEntityPropertyValue(customerArray[10]));
