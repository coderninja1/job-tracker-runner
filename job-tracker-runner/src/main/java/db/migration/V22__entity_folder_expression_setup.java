...
public class V22__entity_folder_expression_setup extends BaseDataMigration {
    ...
    protected void insertData() {
        ...
        processPurchaseOrderFolderSetup(createFolderOperation, afterCreateExpressionFieldSetterOperation);
    ...
    public EntityExpression createAndSaveBasePurchaseOrderFolderPathEntityExpression() {
        return createAndSaveEntityExpression(
                "Purchase Order Base Folder Path",
                "Defines the base folder path for a Purchase Order.",
                "${purchaseOrder.job.folderLocation}${purchaseOrder.name}" + File.separator,
                null
        );
    }
    ...
    private void processPurchaseOrderFolderSetup(EntityExpressionOperation createFolderOperation, EntityExpressionOperation afterCreateExpressionFieldSetterOperation) {
        EntityExpression basePurchaseOrderFolderPathEntityExpression = createAndSaveBasePurchaseOrderFolderPathEntityExpression();

        //Create Project Folder and Set it on field
        assignExpressionAndOperationToEntity(
                "Purchase Order Branch Folder Creation",
                "Creates the branch code top level folder when a new Purchase Order is created.",
                "PurchaseOrder",
                null,
                createFolderOperation,
                basePurchaseOrderFolderPathEntityExpression
        );
        assignExpressionAndOperationToEntity(
                "Purchase Order Folder Location Setter",
                "Dynamically resolves the correct folder location and sets it on new Purchase Order creation.",
                "PurchaseOrder",
                "folderLocation",
                afterCreateExpressionFieldSetterOperation,
                basePurchaseOrderFolderPathEntityExpression
        ...
        createRemainingPurchaseOrderCustomerFolderStructure(basePurchaseOrderFolderPathEntityExpression, createFolderOperation);
    }
